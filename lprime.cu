...
/* Adapted for llrp program by Jean Penné */
...
/* -V - version number */
		...
		case 'V':
		case 'v':
			printf ("Primality Testing of k*b^n+/-1 Program - GPU Version 3.8.1 ; linked with CUDA Version 8.0.44\n");
			return (0); 
...
// Process the file name
	...
	readIniFiles ();			// Read again the init. files, that may have been updated...
...
/* Bring up the main menu */
	...
	if (MENUING)
        ...
        if(CPU_AFFINITY != 99) device_number = CPU_AFFINITY;
