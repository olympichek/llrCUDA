...
void ell_even(giant x1, giant z1, giant x2, giant z2, giant An, giant Ad, giant N);

void ell_odd(giant x1, giant z1, giant x2, giant z2, giant xorg, giant zorg, giant N);
...
)
{
	...
	if (randmode == 0)
	{
		if (display) {
			OutputStr((char*)"\n");
			OutputStr((char*)"Commencing Pollard rho...\n");
		}
		itog(1, gg);
		itog(3, t1); itog(3, t2);
		...
		if (display) {
			OutputStr ((char*)"\n");
			OutputStr ((char*)"Commencing Pollard (p-1)...\n");
		}
		itog(1, gg);
		itog(3, t1);
